...
const OlaUberRemark = () => {
  ...
  const encryptID = encrypt(referenceId);
  const encryptUser = encrypt("0");

  const generateRejectLink = () => {
    return API_GET_APPROVAL_SUMMARY(encryptID, "Remark", text, encryptUser);
  };
