...
const RepairReplies = ({ reply, id, AttachmentDetails }) => {
                ...
                return (
                  <li key={item.id} className="" data-id={item.id}>
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: item.description }} // Ensure item.Reply is safe
                    />

                    <small className="text-muted">
                      Reply by {item.name} On {item.created_date}
                    </small>
                    <hr />
                  </li>
                );
