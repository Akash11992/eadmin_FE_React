const VoucherOfficeBoyEmail = (getData) => {
        ...
        <body>
          <div style="font-family: Arial, sans-serif;">
            ...
            <div style="margin-top: 20px; text-align: center;">
              <a href="${API}/itemService/updatestatusinwarditem/${getData?.voucher_number || ""}" 
...
export default VoucherOfficeBoyEmail;
