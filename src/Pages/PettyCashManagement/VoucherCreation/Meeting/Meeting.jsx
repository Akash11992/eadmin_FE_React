...
const Meeting = ({ formState, isViewMode, path }) => {
      ...
      return [
        {
          ...
          approverName:
            approverDetails?.Employee || dataToUse["User Name"] || "",
          approverId: dataToUse.user_id || "",
          company_details: dataToUse.company_id || "",
          user_details: dataToUse.department || "",
          service: dataToUse.Service || "",
          expenses: dataToUse.Expense || "",
  ...
  const handleSave = async (status) => {
    ...
    try {
      ...
      if (response?.meta?.requestStatus === "fulfilled") {
        toast.success("Meeting expense voucher saved successfully");
  ...
  if (formState.selectedVoucherValue == 5 || voucherType == "5") {
    return (
      <div id="meeting-expense-form">
        <ToastContainer
          position="top-right"
          autoClose={5000}
              ...
              <tbody>
                      ...
                      <CustomAutoComplete
                        ...
                        value={
                          userNameDropdown.find(
                            (item) =>
                              item.Employee === row.approverName ||
                              item.Emp_id === row.approverId
                          ) || ""
                        }
                        style={{ width: "100%" }}
                ...
                <tr>
                  ...
                  >
                    ...
                    <span>
                      {rows.reduce(
                        (total, row) => total + (parseFloat(row.expenses) || 0),
                        0
                      )}
                    </span>
                  </td>
