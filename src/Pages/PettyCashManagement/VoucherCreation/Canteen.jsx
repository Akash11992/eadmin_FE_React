...
const Canteen = ({ formState, isViewMode, path }) => {
  ...
  const [rows, setRows] = useState(() => {
    if (voucherData) {
      ...
      // Find employee details if available
  ...
  const handleGetFile = async () => {
    const referenceNo = isEditMode
      ? voucherData?.["Voucher ID"]
      : voucherData?.[0]?.voucher_number;
    const Payload = {
      referenceName: "Petty Cash Management",
      referenceKey: referenceNo,
  ...
  const handleInput = (e, index) => {
    ...
    if (name === "quantity" || name === "rate") {
      const quantity = parseFloat(
        name === "quantity" ? value : updatedRow.quantity || 0
      );
      const rate = parseFloat(name === "rate" ? value : updatedRow.rate || 0);
  ...
  if (formState.selectedVoucherValue == "2" || voucherType == "2") {
    return (
                ...
                <tr>
                  ...
                  <th
                    style={{
                      backgroundColor: "#d90429",
                      color: "white",
                      minWidth: "175px", // This sets User Name column width
                    }}
                  >
                    User Name
                  </th>
                  ...
                  <th
                    style={{
                      backgroundColor: "#d90429",
                      color: "white",
                      minWidth: "175px", // Matching User Name width
                    }}
                  >
                    Particulars
                  </th>
                  ...
                  <th
                    style={{
                      backgroundColor: "#d90429",
                      color: "white",
                      width: "80px", // Keeping Add button column narrower
                    }}
                  >
                    Add
                  </th>
