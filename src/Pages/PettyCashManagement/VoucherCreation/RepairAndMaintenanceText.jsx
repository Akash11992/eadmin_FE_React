...
const RepairAndMaintenance = ({ formState, isViewMode, path }) => {
      ...
      return [
        {
          ...
          areaName: dataToUse["Area"] || dataToUse.areaName || "",
          service: dataToUse.Service || dataToUse.service || "",
          rate: dataToUse.Rate || dataToUse.rate || "",
          amount: dataToUse.Amount || dataToUse.amount || "",
          remark: dataToUse.Remark || dataToUse.remark || "",
  ...
  const handleInput = (e, index) => {
    ...
    updatedRows[index] = {
      ...
      ...(name === "rate" && {
        amount: value, // For repair and maintenance, amount is directly entered
      }),
    };
  ...
  if (formState.selectedVoucherValue == "3" || voucherType == "3") {
    return (
                    ...
                    <td style={{ minWidth: "175px" }}>
                      ...
                      {row.file && !file && (
                        <div className="mt-1">
                          ...
                          {voucherData?.Document_URL && (
                            <a
                              href={voucherData.Document_URL}
                              target="_blank"
