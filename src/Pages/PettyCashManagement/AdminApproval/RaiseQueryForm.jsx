    ...
    try {
      if (uncheckedRows.length > 0) {
        ...
        await axios.get(
          ...
          }/api/approve-admin?q=${encodeURIComponent(encryptedData)}`
        );
      }
      const result = await axios.post(
        `${process.env.REACT_APP_API}/api/raise-query-admin`,
        {
          data: {
          ...
          <div className="col-md-10" style={{ overflowX: "auto" }}>
            ...
            <div className="mt-4">
              <p className="fw-semibold">
                Please provide a reason for raise query{" "}
